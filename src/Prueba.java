...
class VentanaPrincipal extends JFrame {
	public VentanaPrincipal(){
		...
		JTextField txtCaja3=new JTextField("*");
		txtCaja3.setHorizontalAlignment(JTextField.RIGHT);
		txtCaja3.setForeground(Color.RED);
		txtCaja3.setBounds(10, 35, 590, 35);
		txtCaja3.setFont(new Font("Times New Roman", 5, 18));
		txtCaja3.setBackground(new Color(240, 240, 240));
		panel1.add(txtCaja3);
		...
		JScrollPane scrollPane2 = new JScrollPane(txtCaja7);
		scrollPane2.setBounds(380, 360, 610, 210);
